    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, User.create({ id: id, namr: name, email: email, password: password, last_login: last_login })];
            case 1:
                _a.sent();
...
// get a login user
var getLoggedUser = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
